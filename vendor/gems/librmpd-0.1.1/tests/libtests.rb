...
class MPDTester < Test::Unit::TestCase
  ...
  def test_listplaylist
    @mpd.connect

    files = @mpd.listplaylist('Shpongle_-_Are_You_Shpongled')

    assert_equal 'Shpongle/Are_You_Shpongled/1.Shpongle_Falls.ogg', files[0]
    assert_equal 'Shpongle/Are_You_Shpongled/2.Monster_Hit.ogg', files[1]
    assert_equal 'Shpongle/Are_You_Shpongled/3.Vapour_Rumours.ogg', files[2]
    assert_equal 'Shpongle/Are_You_Shpongled/4.Shpongle_Spores.ogg', files[3]
    assert_equal 'Shpongle/Are_You_Shpongled/5.Behind_Closed_Eyelids.ogg', files[4]
    assert_equal 'Shpongle/Are_You_Shpongled/6.Divine_Moments_of_Truth.ogg', files[5]
    assert_equal 'Shpongle/Are_You_Shpongled/7...._and_the_Day_Turned_to_Night.ogg', files[6]
  end
